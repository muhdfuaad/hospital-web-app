...
"[project]/src/app/(dashboard)/nurse-consultations/details/page.tsx [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
            ...
            try {
                ...
                const assignmentsWithDataPromises = patientAssignments.map(async (assignment)=>{
                    ...
                    if (assignment.nurseId) {
                        try {
                            const docRes = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$axios$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].get(`/api/Nurses/by-nurse-id/${assignment.nurseId}`);
                    ...
                    let notes = [];
                    try {
                        const notesRes = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$axios$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].get(`/api/NursesNotes/by-assignment/${assignment.assignmentId}`);
                    ...
                    let reviews = [];
                    try {
                        const reviewsRes = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$axios$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].get(`/api/NursesReviews/by-assignment/${assignment.assignmentId}`);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__166d1b92._.js.map