...
"[project]/src/app/(dashboard)/doctorsnote/page.tsx [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function DoctorsNoteForm() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        ...
        const fetchDoctorNote = async ()=>{
            try {
                const res = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$axios$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].get(`/api/DoctorsNotes/review/${assignment}`);
    ...
    const handleSubmit = async ()=>{
        ...
        try {
            ...
            const url = isEditMode ? `/api/DoctorsNotes/review/${formData.reviewId}` // now the real reviewId
             : `/api/DoctorsNotes`;
            if (isEditMode) {
                await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$axios$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].put(url, dataToSend);
            } else {
                await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$axios$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].post(url, dataToSend);
            }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__85b86967._.js.map