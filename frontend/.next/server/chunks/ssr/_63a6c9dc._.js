...
const SupplierForm = ()=>{
    ...
    const fetchTypes = async ()=>{
        try {
            const response = await fetch('https://localhost:7112/api/SupplierTypes');
    ...
    const handleSubmit = async ()=>{
        ...
        const supplierPayload = {
            ...
            supplierTypeId: parseInt(formData.type),
            gstNo: formData.gstNo,
            discPercentage: parseFloat(formData.discPercentage || "0") || null
        };
        try {
            ...
            alert(editId ? 'Supplier updated successfully!' : 'Supplier registered successfully!');
...
//# sourceMappingURL=_63a6c9dc._.js.map