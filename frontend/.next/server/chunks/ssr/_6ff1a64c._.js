...
function DoctorsNoteForm() {
    ...
    const handleSubmit = ()=>{
        if (!formData.historyOfIllness.trim()) {
            setSubmitMessage('Please provide the history of illness.');
            setSubmitStatus('error');
            return;
        }
        setSubmitMessage("Doctor's Note has been successfully submitted!");
...
//# sourceMappingURL=_6ff1a64c._.js.map