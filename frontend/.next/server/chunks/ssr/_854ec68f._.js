...
"[project]/src/app/(dashboard)/volunteersnote/page.tsx [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const VolunteersReviewForm = ()=>{
    ...
    const handleEditProcedure = async (column)=>{
        ...
        setFormData((prev)=>{
            ...
            const updatedProcedures = prev.customProcedures.map((p)=>p === column ? newName : p);
        ...
        setAllProcedures((prev)=>prev.map((proc)=>proc === column ? newName : proc));
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        fetch("https://localhost:7112/api/VolunteersNotes/procedures").then((res)=>res.ok ? res.json() : Promise.reject()).then((data)=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        ...
        fetch(`https://localhost:7112/api/PatientAssignments/byAssignmentId/${assignment}`).then((res)=>res.ok ? res.json() : Promise.reject()).then((assignmentData)=>{
        ...
        }).then((res)=>res.ok ? res.json() : Promise.reject()).then((patientData)=>{
            setPatientInfo({
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        const assignment = searchParams.get("assignmentId");
        if (!assignment) return;
        fetch(`https://localhost:7112/api/VolunteersNotes/review/${assignment}`).then((res)=>res.status === 404 ? null : res.ok ? res.json() : Promise.reject()).then((data)=>{
            if (!data) return;
    ...
    const handleSubmit = async (e)=>{
        ...
        try {
            ...
            const url = formData.id ? `https://localhost:7112/api/VolunteersNotes/${formData.id}` : "https://localhost:7112/api/VolunteersNotes";
                            ...
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$heart$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__default__as__Heart$3e$__["Heart"], {
                                        ...
                                        fileName: "[project]/src/app/(dashboard)/volunteersnote/page.tsx",
                                        lineNumber: 344,
                                        columnNumber: 33
                                    }, this)
                                }, void 0, false, {
                                                ...
                                                children: [
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                                        ...
                                                        children: [
                                                            column,
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                className: "flex gap-1 opacity-0 group-hover:opacity-100 transition-opacity duration-300 ml-2",
                                                                children: [
...
const __TURBOPACK__default__export__ = VolunteersReviewForm;
}}),
...
//# sourceMappingURL=_854ec68f._.js.map