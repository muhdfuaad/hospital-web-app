...
"[project]/src/app/purchasebill/page.tsx [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const PurchaseBillPage = ()=>{
    ...
    // Calculate totals
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        const grossTotal = purchaseBill.items.reduce((sum, item)=>{
            const qty = parseFloat(item.qty) || 0;
            const rate = parseFloat(item.purchaseRate) || 0;
            return sum + qty * rate;
        }, 0);
        const gstTotal = purchaseBill.items.reduce((sum, item)=>{
            const qty = parseFloat(item.qty) || 0;
            const rate = parseFloat(item.purchaseRate) || 0;
...
//# sourceMappingURL=src_app_purchasebill_page_tsx_c7e8f277._.js.map