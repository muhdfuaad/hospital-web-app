...
const VolunteersReviewForm = ()=>{
    ...
    const handleEditProcedure = (column)=>{
    ...
    const handleDeleteProcedure = (column)=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "VolunteersReviewForm.useEffect": ()=>{
            ...
            console.log("🧠 Fetching existing VolunteersNote by reviewId:", assignment);
            fetch(`https://localhost:7112/api/VolunteersNotes/review/${assignment}`).then({
                "VolunteersReviewForm.useEffect": async (res)=>{
                    if (!res.ok) {
                        const err = await res.text();
                        throw new Error(`❌ Error fetching VolunteersNote: ${res.status} - ${err}`);
                    }
                    return res.json();
                }
            }["VolunteersReviewForm.useEffect"]).then({
                "VolunteersReviewForm.useEffect": (data)=>{
                    console.log("✅ Prefilled VolunteersNote:", data);
                ...
                "VolunteersReviewForm.useEffect": (err)=>{
    ...
    const handleSubmit = async (e)=>{
        ...
        try {
            const response = await fetch("https://localhost:7112/api/VolunteersNotes", {
                method: "POST",
                headers: {
...
_s(VolunteersReviewForm, "5PzlmzVW6Z+E8N0kZq2K4bfhrJ0=", false, function() {
    return [
...
//# sourceMappingURL=_689dea1d._.js.map