...
"[project]/src/app/viewpage/appform/page.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function HospitalRegistrationForm() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "HospitalRegistrationForm.useEffect": ()=>{
            ...
            if (isEditMode && raw) {
                ...
                const dig = {
                    "HospitalRegistrationForm.useEffect.dig": (...keys)=>keys.reduce({
                            "HospitalRegistrationForm.useEffect.dig": (out, k)=>out !== "" ? out : p?.[k] ?? ""
                        }["HospitalRegistrationForm.useEffect.dig"], "")
                }["HospitalRegistrationForm.useEffect.dig"];
                setFormData({
    ...
    return(// <main className="min-h-screen w-full bg-gradient-to-br from-blue-50 to-blue-100 px-10 py-8">
...
_s(HospitalRegistrationForm, "Fu3rJCbiODR9dRLBWpKeh2DamBw=");
...
//# sourceMappingURL=_84bf83d1._.js.map