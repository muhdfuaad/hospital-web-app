...
const SupplierForm = ()=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "SupplierForm.useEffect": ()=>{
            async function fetchSupplierTypesAndSupplierData() {
                try {
                    // Step 1: Fetch supplier types for dropdown
                    const typesRes = await fetch('https://localhost:7112/api/Suppliers/types');
                    if (!typesRes.ok) {
                        throw new Error('Failed to fetch supplier types');
                    }
                    const typesData = await typesRes.json();
                    const mappedTypes = typesData.map({
                    ...
                    // Step 2: If editing, fetch the supplier data
                    if (editId) {
                        setIsEditMode(true);
                        const res = await fetch(`https://localhost:7112/api/Suppliers/${editId}`);
                        if (!res.ok) {
                            console.error('Failed to fetch supplier data for edit');
                            return;
                        }
                    ...
                    console.error('SupplierTypes or Supplier fetch error:', error);
                }
            }
    ...
    const handleAddType = async ()=>{
        ...
        try {
            const response = await fetch('https://localhost:7112/api/Suppliers/types', {
                ...
                body: JSON.stringify({
                    TypeName: trimmed
                }) // ✅ use capitalized key matching backend DTO
            });
            if (!response.ok) {
    ...
    const handleSubmit = async ()=>{
        ...
        try {
            const endpoint = editId ? `https://localhost:7112/api/Suppliers/${editId}` : 'https://localhost:7112/api/Suppliers';
                ...
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: [
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    className: "absolute top-4 right-4 opacity-20 text-6xl"
                                }, void 0, false, {
                                    fileName: "[project]/src/app/(dashboard)/Suppliers/addSupplier/page.tsx",
                                    lineNumber: 425,
                                    columnNumber: 25
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: [
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h1", {
                                            className: "text-3xl sm:text-4xl font-extrabold tracking-wide drop-shadow-lg animate-fade-in-up",
                                    ...
                                    children: [
                                                                        ...
                                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                            ...
                                                                            children: [
                                                                                ...
                                                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("select", {
                                                                                    ...
                                                                                    className: `w-full pl-12 pr-4 py-2 border-2 rounded-md transition-all duration-200 ${errors.type ? 'border-red-300 focus:border-red-500' : 'border-gray-300 focus:border-blue-500'} focus:outline-none focus:ring-2 focus:ring-blue-200`,
                                                                                    children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                                ...
                                                children: [
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                        className: "absolute inset-0 bg-gradient-to-r from-purple-600 to-blue-600 transform scale-x-0 group-hover:scale-x-100 transition-transform duration-300 origin-left"
                                                    }, void 0, false, {
                                                        fileName: "[project]/src/app/(dashboard)/Suppliers/addSupplier/page.tsx",
                                                        lineNumber: 646,
                                                        columnNumber: 41
...
//# sourceMappingURL=_afc72a97._.js.map