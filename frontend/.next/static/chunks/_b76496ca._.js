...
"[project]/src/app/(dashboard)/volunteersnote/page.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const VolunteersReviewForm = ()=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "VolunteersReviewForm.useEffect": ()=>{
            fetch("https://localhost:7112/api/VolunteersNotes/procedures").then({
                "VolunteersReviewForm.useEffect": (res)=>res.ok ? res.json() : Promise.reject()
            }["VolunteersReviewForm.useEffect"]).then({
                "VolunteersReviewForm.useEffect": (data)=>{
                    const names = data.map({
                        "VolunteersReviewForm.useEffect.names": (proc)=>proc.name
                    }["VolunteersReviewForm.useEffect.names"]);
                    setAllProcedures(names);
                }
            }["VolunteersReviewForm.useEffect"]).catch({
                "VolunteersReviewForm.useEffect": ()=>{}
            }["VolunteersReviewForm.useEffect"]);
        }
    }["VolunteersReviewForm.useEffect"], []);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "VolunteersReviewForm.useEffect": ()=>{
            setFormData({
                "VolunteersReviewForm.useEffect": (prev)=>{
                    const updatedCells = {
                        ...prev.cells
                    };
                    const updatedDescriptions = {
                    ...
                    allProcedures.forEach({
                        "VolunteersReviewForm.useEffect": (proc)=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "VolunteersReviewForm.useEffect": ()=>{
            ...
            fetch(`https://localhost:7112/api/PatientAssignments/byAssignmentId/${assignment}`).then({
                ...
                "VolunteersReviewForm.useEffect": (assignmentData)=>{
                ...
                "VolunteersReviewForm.useEffect": (patientData)=>{
                    setPatientInfo({
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "VolunteersReviewForm.useEffect": ()=>{
            const assignment = searchParams.get("assignmentId");
            if (!assignment) return;
            fetch(`https://localhost:7112/api/VolunteersNotes/review/${assignment}`).then({
                "VolunteersReviewForm.useEffect": (res)=>res.status === 404 ? null : res.ok ? res.json() : Promise.reject()
            }["VolunteersReviewForm.useEffect"]).then({
                "VolunteersReviewForm.useEffect": (data)=>{
                    if (!data) return;
...
_s(VolunteersReviewForm, "Eq24TuoKMmuBR+nExzbdAxK1Cpw=", false, function() {
    return [
...
//# sourceMappingURL=_b76496ca._.js.map