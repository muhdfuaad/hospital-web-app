...
"[project]/src/app/doctorsnote/page.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function DoctorsNoteForm() {
    ...
    const [isEditMode, setIsEditMode] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false); // ✅ Track if we are in edit mode
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "DoctorsNoteForm.useEffect": ()=>{
            ...
            fetch(`https://localhost:7112/api/PatientAssignments/byAssignmentId/${assignment}`).then({
                "DoctorsNoteForm.useEffect": async (res)=>{
                    if (!res.ok) {
            ...
            }["DoctorsNoteForm.useEffect"]).then({
                "DoctorsNoteForm.useEffect": (assignmentData)=>{
                    ...
                    setFormData({
                        "DoctorsNoteForm.useEffect": (prev)=>({
                                ...prev,
                                reviewId: assignment,
                ...
                "DoctorsNoteForm.useEffect": (patientData)=>{
            ...
            }["DoctorsNoteForm.useEffect"]).catch({
                "DoctorsNoteForm.useEffect": (err)=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "DoctorsNoteForm.useEffect": ()=>{
            ...
            fetch(`https://localhost:7112/api/DoctorsNotes/review/${assignment}`).then({
                "DoctorsNoteForm.useEffect": async (res)=>{
                    if (!res.ok) {
                ...
                "DoctorsNoteForm.useEffect": (data)=>{
                    ...
                    if (data.symptoms && Array.isArray(data.symptoms)) {
                        const mappedSymptoms = data.symptoms.map({
                            "DoctorsNoteForm.useEffect.mappedSymptoms": (s)=>({
                                    name: s.name || '',
                                    pqrstDescription: s.pqrstDescription || ''
                                })
                        }["DoctorsNoteForm.useEffect.mappedSymptoms"]);
                                                ...
                                                children: [
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        ...
                                                        children: [
                                                            ...
                                                            symptoms.length > 3 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                                                type: "button",
...
_s(DoctorsNoteForm, "VzdRvW4qPwf6lXAULLHPw8k+ovU=", false, function() {
    return [
...
//# sourceMappingURL=_d31b2470._.js.map