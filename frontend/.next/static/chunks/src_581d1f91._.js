...
const PurchaseBillPage = ()=>{
    ...
    const fieldRefs = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])({});
        ...
        setPurchaseBill((prev)=>({
                ...
                items: prev.items.map((item)=>{
                    if (item.id === itemId) {
                        ...
                        // 🔁 Updated based on supplier location (taxType)
...
_s(PurchaseBillPage, "564RTRTiTFeDmfYomCni/se5PDk=");
_c = PurchaseBillPage;
...
//# sourceMappingURL=src_581d1f91._.js.map