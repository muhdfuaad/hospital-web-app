...
const DoctorsReviewForm = ()=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "DoctorsReviewForm.useEffect": ()=>{
            const handleClickOutside = {
                "DoctorsReviewForm.useEffect.handleClickOutside": (event)=>{
                    if (editingItem !== null && dropdownRefs.current[editingItem] && !dropdownRefs.current[editingItem]?.contains(event.target)) {
                        setEditingItem(null);
                    }
                }
            }["DoctorsReviewForm.useEffect.handleClickOutside"];
            document.addEventListener('mousedown', handleClickOutside);
            return ({
                "DoctorsReviewForm.useEffect": ()=>document.removeEventListener('mousedown', handleClickOutside)
            })["DoctorsReviewForm.useEffect"];
        }
    }["DoctorsReviewForm.useEffect"], [
        editingItem
        ...
        "DoctorsReviewForm.useEffect": ()=>{
            const fetchMedicines = {
                "DoctorsReviewForm.useEffect.fetchMedicines": async ()=>{
                    try {
                        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$axios$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get('/api/Medicines/dropdown');
    ...
    const MedicineDropdown = ({ itemId, medicines, onSelect, onClose, inputElement })=>{
        _s1();
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
            "DoctorsReviewForm.MedicineDropdown.useEffect": ()=>{
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
            "DoctorsReviewForm.MedicineDropdown.useEffect": ()=>{
                function handleClickOutside(event) {
                    ...
                    if (!inputElement?.contains(target) && !target.closest(`#medicine-dropdown-${itemId}`)) {
                        onClose();
                    }
                }
                document.addEventListener('mousedown', handleClickOutside);
                return ({
                    "DoctorsReviewForm.MedicineDropdown.useEffect": ()=>document.removeEventListener('mousedown', handleClickOutside)
                })["DoctorsReviewForm.MedicineDropdown.useEffect"];
            }
        }["DoctorsReviewForm.MedicineDropdown.useEffect"], [
            inputElement,
        ...
        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2d$dom$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createPortal"])(/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            children: medicines.length > 0 ? medicines.map((med)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
    ...
    _s1(MedicineDropdown, "4pE9Tdswazzx7jNtbstOdCsQi5c=");
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "DoctorsReviewForm.useEffect": ()=>{
            ...
            const fetchAssignmentAndPatient = {
                "DoctorsReviewForm.useEffect.fetchAssignmentAndPatient": async ()=>{
                    try {
                        ...
                        setFormData({
                            "DoctorsReviewForm.useEffect.fetchAssignmentAndPatient": (prev)=>({
                                    ...prev,
                                    reviewId: assignment,
                                    patientId: assignmentData.patientId
                                })
                        }["DoctorsReviewForm.useEffect.fetchAssignmentAndPatient"]);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "DoctorsReviewForm.useEffect": ()=>{
            const initialTerms = {};
            medications.forEach({
                "DoctorsReviewForm.useEffect": (item)=>{
                    if (item.medicine) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "DoctorsReviewForm.useEffect": ()=>{
            ...
            const fetchReview = {
                "DoctorsReviewForm.useEffect.fetchReview": async ()=>{
                    try {
                        ...
                        setNoteExists(true);
                        setFormData({
                            "DoctorsReviewForm.useEffect.fetchReview": (prev)=>({
                                    ...prev,
                                    reviewId: review.reviewId || "",
                                    patientId: review.patientId || "",
                                    date: review.date?.split("T")[0] || ""
                                })
                        }["DoctorsReviewForm.useEffect.fetchReview"]);
                        // Set investigations
                        if (Array.isArray(review.investigations)) {
                            setInvestigations(review.investigations.map({
                                "DoctorsReviewForm.useEffect.fetchReview": (inv)=>({
                                        id: inv?.id ?? 0,
                        ...
                        if (Array.isArray(review.medications)) {
                            setMedications(review.medications.map({
                                "DoctorsReviewForm.useEffect.fetchReview": (med)=>({
                                        id: med?.id ?? 0,
    ...
    const handleSubmit = async (e)=>{
        ...
        try {
            ...
            const url = isEditMode ? `/api/DoctorsReviews/byReviewId/${formData.reviewId}` : `/api/DoctorsReviews`;
            if (isEditMode) {
                        ...
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        className: "overflow-x-auto overflow-y-visible relative max-h-[400px]",
                                                    ...
                                                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tr", {
                                                        ...
                                                        children: [
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("th", {
                                                                className: "border border-gray-300 px-3 py-2 text-left font-semibold text-blue-900 w-[5%]",
                                                                children: "SI.No"
                                                            }, void 0, false, {
                                                                fileName: "[project]/src/app/(dashboard)/doctorsreview/page.tsx",
                                                                lineNumber: 504,
                                                            ...
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("th", {
                                                                className: "border border-gray-300 px-3 py-2 text-left font-semibold text-blue-900 w-[55%]",
                                                                children: "Findings"
                                                            }, void 0, false, {
                                                                fileName: "[project]/src/app/(dashboard)/doctorsreview/page.tsx",
                                                                lineNumber: 510,
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("thead", {
                                                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tr", {
                                                            ...
                                                            children: [
                                                                ...
                                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("th", {
                                                                    className: "border border-gray-300 px-3 py-2 text-left font-semibold text-blue-900 w-[45%]",
                                                                    children: "Remarks"
                                                                }, void 0, false, {
                                                                    fileName: "[project]/src/app/(dashboard)/doctorsreview/page.tsx",
                                                                    lineNumber: 585,
                                                                ...
                                                                children: [
                                                                    ...
                                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                                                        ...
                                                                        children: [
                                                                            ...
                                                                            editingItemId === item.id && inputRefs.current[item.id] && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(MedicineDropdown, {
                                                                                itemId: item.id,
                                                                                ...
                                                                                onSelect: (medicineName)=>{
                                                                                    ...
                                                                                    setMedicineSearchTerm((prev)=>({
                                                                                            ...prev,
                                                                                            [item.id]: medicineName
                                                                                        }));
                                                                                    setEditingItemId(null);
                                                                                },
                                                                                onClose: ()=>setEditingItemId(null),
                                                                                inputElement: inputRefs.current[item.id]
                                                                            }, void 0, false, {
                                                                                fileName: "[project]/src/app/(dashboard)/doctorsreview/page.tsx",
                                                                                lineNumber: 632,
                                                                                columnNumber: 57
...
_s(DoctorsReviewForm, "T78MZL+/d1Pe6AvpRstXqqlxQac=", false, function() {
    return [
...
//# sourceMappingURL=src_716c1b18._.js.map