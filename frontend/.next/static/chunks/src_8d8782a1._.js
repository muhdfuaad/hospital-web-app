...
"[project]/src/app/(dashboard)/Suppliers/addSupplier/page.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const InputField = ({ icon: Icon, label, name, type = 'text', required = false, className = '', value, onChange, error, ...props })=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        className: className,
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("label", {
                ...
                children: [
                    ...
                    required && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                        ...
                        fileName: "[project]/src/app/(dashboard)/Suppliers/addSupplier/page.tsx",
                        lineNumber: 110,
                        columnNumber: 38
                    }, this)
                ]
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("input", {
                        ...
                        value: value,
                        onChange: onChange,
                        className: `w-full pl-12 pr-4 py-2 border-2 rounded-md transition-all duration-200 ${error ? 'border-red-300 focus:border-red-500' : 'border-gray-300 focus:border-blue-500'} focus:outline-none focus:ring-2 focus:ring-blue-200`,
                        ...props
                    }, void 0, false, {
                        fileName: "[project]/src/app/(dashboard)/Suppliers/addSupplier/page.tsx",
                        lineNumber: 118,
...
const TextAreaField = ({ icon: Icon, label, name, required = false, className = '', rows = 2, value, onChange, error })=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        className: className,
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("label", {
                className: "block text-sm font-medium text-gray-700 mb-1",
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("textarea", {
                        ...
                        onChange: onChange,
                        rows: rows,
                        className: `w-full pl-12 pr-4 py-2 border-2 rounded-md transition-all duration-200 ${error ? 'border-red-300 focus:border-red-500' : 'border-gray-300 focus:border-blue-500'} focus:outline-none focus:ring-2 focus:ring-blue-200 resize-none`
                    }, void 0, false, {
                        fileName: "[project]/src/app/(dashboard)/Suppliers/addSupplier/page.tsx",
                        lineNumber: 158,
                        columnNumber: 17
...
const SupplierForm = ()=>{
        ...
        "SupplierForm.useEffect": ()=>{
            async function fetchSupplierTypesAndSupplierData() {
                try {
                    ...
                    const typesRes = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$axios$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get('/api/Suppliers/types');
                    const mappedTypes = typesRes.data.map({
                        "SupplierForm.useEffect.fetchSupplierTypesAndSupplierData.mappedTypes": (type)=>({
                                id: type.supplierTypeId,
                                name: type.typeName
                            })
                    }["SupplierForm.useEffect.fetchSupplierTypesAndSupplierData.mappedTypes"]);
                    setTypes(mappedTypes);
                    // ✅ Step 2: Fetch supplier data for editing
                    if (editId) {
                        setIsEditMode(true);
                        const res = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$axios$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get(`/api/Suppliers/${editId}`);
                        const data = res.data;
                        setFormData({
                            accNo: data.accNo ?? '',
                            name: data.name ?? '',
    ...
    const handleAddType = async ()=>{
        ...
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$axios$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post('/api/Suppliers/types', {
                TypeName: trimmed
            });
            ...
            alert(error?.response?.data || 'Something went wrong while adding the type.');
        }
    };
    ...
    const handleSubmit = async ()=>{
        ...
        const supplierPayload = {
            ...
            supplierTypeId: formData.type ? parseInt(formData.type) : null,
            gstNo: formData.gstNo,
            discPercentage: formData.discPercentage?.toString() || "0"
        };
        try {
            const endpoint = editId ? `${API_BASE}/api/Suppliers/${editId}` : `${API_BASE}/api/Suppliers`;
                ...
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: [
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h1", {
                            className: "text-3xl sm:text-4xl font-light mb-3 tracking-wide drop-shadow-lg animate-fade-in-up",
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                            ...
                            children: "Fill in the details to register a new supplier!"
                        }, void 0, false, {
                            fileName: "[project]/src/app/(dashboard)/Suppliers/addSupplier/page.tsx",
                            lineNumber: 432,
                            columnNumber: 21
    ...
    focus:outline-none focus:ring-2 focus:ring-blue-200`,
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                    ...
                                    children: [
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                            className: "absolute inset-0 bg-gradient-to-r from-blue-300 to-blue-600 transform scale-x-0 group-hover:scale-x-100 transition-transform duration-300 origin-left"
                                        }, void 0, false, {
                                            fileName: "[project]/src/app/(dashboard)/Suppliers/addSupplier/page.tsx",
                                            lineNumber: 648,
                                            columnNumber: 33
            ...
            showTypeModal && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: [
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            className: "bg-gradient-to-r from-blue-900 to-blue-700 text-white px-6 py-4 rounded-t-lg flex justify-between items-center",
                            children: [
...
_s(SupplierForm, "nLn4UfyvKwVd+uOaWp6jiwjA9aE=", false, function() {
    return [
...
//# sourceMappingURL=src_8d8782a1._.js.map