...
"[project]/src/app/viewAssignments/page.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function PatientAssignmentsViewPage() {
    ...
    const fetchAllPersonsData = async ()=>{
        try {
            ...
            doctors.forEach((doctor)=>{
                ...
                if (id) {
                    const fullName = doctor.name || doctor.fullName || doctor.doctorName || `${doctor.firstName || ''} ${doctor.lastName || ''}`.trim();
    ...
    const getPersonDetails = (id, type)=>{
        const personKey = `${type}_${id}`;
    ...
    const filteredAssignments = assignments.filter((assignment)=>{
        ...
        return assignmentId.includes(searchLower) || patientId.includes(searchLower) || doctorId.includes(searchLower) || volunteerId.includes(searchLower) || nurseId.includes(searchLower) || description.includes(searchLower) || patientName.includes(searchLower) || doctorName.includes(searchLower) || volunteerName.includes(searchLower) || nurseName.includes(searchLower);
    });
    ...
    if (loading) return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                children: "Loading assignment records..."
            }, void 0, false, {
                fileName: "[project]/src/app/viewAssignments/page.tsx",
                lineNumber: 283,
                columnNumber: 13
...
_s(PatientAssignmentsViewPage, "H5CgdmxbyAx0rSCI1utqkdVtUF8=", false, function() {
    return [
...
//# sourceMappingURL=src_app_viewAssignments_page_tsx_860a6b24._.js.map