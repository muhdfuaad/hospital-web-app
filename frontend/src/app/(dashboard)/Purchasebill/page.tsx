...
export default function PurchaseBillsPage() {
    ...
    function getTaxTypeLabel(taxType: number): string {
        switch (taxType) {
            case 0:
                return "(CGST + SGST)";
            case 1:
                    ...
                    <table className="min-w-full border border-gray-300 border-collapse">
                        <thead className="bg-cyan-100">
                            <tr>
                                ...
                                <th className="px-4 py-3 text-left text-sm font-semibold text-gray-700 border border-gray-300">Tax Type</th>
                        ...
                        <tbody>
                            {filteredBills.map(bill => (
                                ...
                                >
                                    ...
                                    <td className="w-31 px-4 py-2 text-sm border border-gray-300">{getPaymentTypeLabel(bill.paymentType)}</td>
                                    <td className="w-31 px-4 py-2 text-sm border border-gray-300">{getTaxTypeLabel(bill.taxType)}</td>
