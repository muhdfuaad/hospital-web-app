...
export default function ClientLayout({ children }: ClientLayoutProps) {
  ...
  md:relative md:translate-x-0`}
      ...
      <div className="flex-1 flex flex-col bg-gray-50 dark:bg-gray-900 h-screen overflow-hidden">
        {/* Header */}
        <header className="flex items-center justify-between px-2 py-2 md:px-6 md:py-3 bg-white dark:bg-gray-800 shadow-lg border-b border-gray-200 dark:border-gray-700 z-10">
