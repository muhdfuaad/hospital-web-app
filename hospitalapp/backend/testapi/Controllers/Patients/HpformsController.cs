...
namespace testapi.Controllers.Patients
{
    ...
    public class HpformsController : ControllerBase
    {
        ...
        public async Task<IActionResult> PutHpformByPatientId(string patientId, [FromForm] HpformsDto hpformDto)
        {
            ...
            existingHpform.District = hpformDto.District;
            existingHpform.Panchayath = hpformDto.Panchayath;
            ...
            existingHpform.Category = hpformDto.Category;
        ...
        public async Task<ActionResult<Hpform>> PostHpform([FromForm] HpformsDto hpformDto)
        {
            ...
            var hpform = new Hpform
            {
                ...
                District = hpformDto.District,
                Panchayath = hpformDto.Panchayath,
                Ward = hpformDto.Ward,
                Area = hpformDto.Area,
                Date = hpformDto.Date,
                Diagnosis = hpformDto.Diagnosis,
                Category = hpformDto.Category,
