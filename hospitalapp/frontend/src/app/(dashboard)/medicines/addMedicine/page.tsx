            ...
            <div className="p-6">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <div className="space-y-4">
                  {/* Rack & Shelf */}
                  <div>
                    <p className="text-xs font-semibold text-gray-500 mb-1">Storage Location</p>
                    <div className="flex items-center gap-4">
                  ...
                  {/* Type */}
                  <div>
                    <p className="text-xs font-semibold text-gray-500 mb-1">Medicine Type</p>
                    <div className="flex items-center gap-4">
                  ...
                  {/* Ingredients */}
                  <div>
                    <p className="text-xs font-semibold text-gray-500 mb-1">Key Ingredients</p>
                    <div className="flex items-center gap-4">
                  ...
                  {/* GST% & Cess */}
                  <div>
                    <p className="text-xs font-semibold text-gray-500 mb-1">Tax Information</p>
                    <div className="flex items-center gap-4">
